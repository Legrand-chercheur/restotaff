...
class deleteCovoiturage extends StatefulWidget {
  const deleteCovoiturage({Key? key}) : super(key: key);

  @override
  State<deleteCovoiturage> createState() => _deleteCovoiturageState();
}

class _deleteCovoiturageState extends State<deleteCovoiturage> {
  @override
