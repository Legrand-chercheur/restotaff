...
class suiviCovoiturage extends StatefulWidget {
  const suiviCovoiturage({Key? key}) : super(key: key);

  @override
  State<suiviCovoiturage> createState() => _suiviCovoiturageState();
}

class _suiviCovoiturageState extends State<suiviCovoiturage> {
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    ...
                                    SizedBox(width: 20,),
                                    Text("Parker jordan",style: TextStyle(fontSize: 20)),
                                  ],
                                ),
                                SizedBox(height: 10,),
                                Row(
                                  children: [
                                    ...
                                    SizedBox(width: 20,),
                                    Text("Libreville-Owendo",style: TextStyle(fontSize: 20)),
                                  ],
                                ),
                              ],
                            ),
