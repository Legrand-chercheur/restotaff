...
class ajoutAssistance extends StatefulWidget {
  const ajoutAssistance({Key? key}) : super(key: key);

  @override
  State<ajoutAssistance> createState() => _ajoutAssistanceState();
}

class _ajoutAssistanceState extends State<ajoutAssistance> {
